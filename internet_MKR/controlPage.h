        ...
        <div class="col-xs-12" style="height: 100vh">
            ...
            <div class="row" style="height: 33.33%; display: flex; align-items: center; justify-content: center;">
                ...
                <div class="col-xs-2" style="text-align: center">
                    <button id="play" type="button" class="btn btn-primary btn-lg">Play Radio</button>
                </div>
                <div class="col-xs-2" style="text-align: center">
                    <button id="pause" type="button" class="btn btn-primary btn-lg">Pause Radio</button>
                </div>
            </div>
            <div class="row"
                style="height: 33.33%; padding-bottom:2em; display: flex; align-items: center; justify-content: center;">
                <div class="col-xs-4" style="text-align: center">
                    <button id="reverse" type="button" class="btn btn-primary btn-lg">Reverse</button>
                </div>
                <div class="col-xs-4"></div>
                <div class="col-xs-2" style="text-align: center">
